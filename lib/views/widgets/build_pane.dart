...
class _BuildPaneState extends State<BuildPane> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredWidgetPalette = _showExperimentalWidgets
        ? _allWidgetPalette
        : _allWidgetPalette.where((entry) => entry.type != 'GlimpseScaffold' && entry.type != 'Column Widget').toList();
...
List<WidgetPaletteEntry> _allWidgetPalette = [
  ...
  WidgetPaletteEntry(
    ...
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseColumn'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseColumn'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseColumn').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseColumn').canHaveChildren,
  ),
  WidgetPaletteEntry(
    label: 'GlimpseRow',
    type: 'GlimpseRow',
    ...
    category: 'Layout Widgets',
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseRow'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseRow'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseRow').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseRow').canHaveChildren,
  ),
  WidgetPaletteEntry(
    ...
    category: 'Layout Widgets',
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseContainer'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseContainer'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseContainer').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseContainer').canHaveChildren,
  ),
  WidgetPaletteEntry(
    ...
    category: 'Layout Widgets',
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseScaffold'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseScaffold'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseScaffold').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseScaffold').canHaveChildren,
  ),
  WidgetPaletteEntry(
    ...
    category: 'Layout Widgets',
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseSizedBox'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseSizedBox'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseSizedBox').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseSizedBox').canHaveChildren,
  ),
  WidgetPaletteEntry(
    label: 'GlimpseSpacer',
    type: 'GlimpseSpacer',
    ...
    category: 'Layout Widgets',
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseSpacer'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseSpacer'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseSpacer').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseSpacer').canHaveChildren,
  ),
  WidgetPaletteEntry(
    label: 'GlimpseText',
    type: 'GlimpseText',
    ...
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseText'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseText'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseText').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseText').canHaveChildren,
  ),
  WidgetPaletteEntry(
    label: 'GlimpseImage',
    type: 'GlimpseImage',
    icon: Icons.image,
    category: 'Display Widgets',
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseImage'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseImage'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseImage').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseImage').canHaveChildren,
  ),
  WidgetPaletteEntry(
    label: 'GlimpseIcon',
    type: 'GlimpseIcon',
    ...
    category: 'Display Widgets',
    childrenInfo: WidgetPropertiesService.getChildrenInfo('GlimpseIcon'),
    properties: WidgetPropertiesService.getPropertyDefinitions('GlimpseIcon'),
    maxChildren: WidgetPropertiesService.getConstraints('GlimpseIcon').maxChildren,
    canHaveChildren: WidgetPropertiesService.getConstraints('GlimpseIcon').canHaveChildren,
  ),
  // GlimpseScaffold and legacy Column Widget are experimental/legacy
  WidgetPaletteEntry(
    label: 'GlimpseScaffold',
    type: 'GlimpseScaffold',
    icon: Icons.web_asset,
